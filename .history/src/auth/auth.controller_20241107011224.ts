...
export class AuthController {
  ...
  @Post('signupAdmin')
  @ApiOperation({ summary: "Create a new admin (only admin creator can create)" })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({ summary: "Convert data to a new token" })
  ...
  @Post('signupLearner')
  @ApiOperation({ summary: 'Add a new learner' })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({ summary: 'The link to activate the learner account' })
  @Get('activate/:link')
